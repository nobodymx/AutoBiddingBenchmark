from Agent.AbidAgent import AbidAgent
from Agent.UbAbidAgent import UbAbidAgent
from Agent.PidAgent import PidAgent
from Agent.MbidAgent import MbidAgent
from Agent.Pid2Agent import Pid2Agent
import numpy as np
...
class Controller:
    def __init__(self,
        ...
        self.agent_candidate_list = [PidAgent, UbAbidAgent, AbidAgent, Pid2Agent]
    ...
    def run_simulation(self, num_trajectory=10, save_data=True):
        ...
        for episode in range(num_trajectory):
            ...
            for tickIndex in range(self.num_tick):
                ...
                if save_data:
                    self.data_logger.add_agent_transitions(store_states, store_actions, store_rewards, store_next_states)
